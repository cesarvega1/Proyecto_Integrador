...
export function renderHome() {
  ...
  <main class="min-h-screen">
    <!-- Preloader Overlay -->
    <div class="fixed inset-0 z-50 flex items-center justify-center bg-zinc-950 animate-slide-up-overlay delay-900 pointer-events-none">
      <div class="text-4xl font-black uppercase text-sport-400 font-display tracking-widest animate-fade-in-delay flex items-center gap-3">
    ...
    <section class="relative flex flex-col lg:flex-row min-h-[85vh] items-center bg-zinc-950 overflow-hidden transition-colors">
      <!-- Fondo decorativo -->
      <div class="absolute inset-0 opacity-20 animate-fade-in-delay delay-1200" style="background-image: radial-gradient(ellipse at 80% 50%, #e05c1a 0%, transparent 60%)"></div>

      <!-- Mitad Texto -->
      <div class="relative z-10 flex-1 px-6 py-20 lg:px-16 xl:px-24 flex flex-col justify-center overflow-hidden">
        <span class="inline-flex items-center gap-3 text-xs font-bold uppercase tracking-widest text-sport-400 mb-8 animate-slide-up-fade delay-1200">
        ...
        <h1 class="text-5xl font-black tracking-tight text-white sm:text-6xl md:text-7xl font-display uppercase leading-none">
          <div class="overflow-hidden"><div class="animate-slide-up-fade delay-500">Rinde al</div></div>
          <div class="overflow-hidden"><div class="animate-slide-up-fade delay-700"><span class="text-sport-400">máximo</span></div></div>
          <div class="overflow-hidden"><div class="animate-slide-up-fade delay-900">nivel</div></div>
        </h1>
        
        <div class="overflow-hidden mt-8">
          <p class="text-lg text-zinc-300 max-w-xl leading-relaxed font-sans font-light animate-slide-up-fade delay-1200">
            Equipate con la mejor ropa técnica, calzado y accesorios deportivos. Todo lo que necesitas para entrenar, competir y ganar.
          </p>
        </div>
        
        <div class="mt-12 flex flex-wrap items-center gap-6 overflow-hidden">
          <div class="animate-slide-up-fade delay-1200 flex flex-wrap items-center gap-6 w-full">
            <a class="flex items-center gap-2 rounded-full bg-sport-500 hover:bg-sport-600 px-8 py-4 text-sm font-bold text-white transition-all hover:shadow-xl hover:-translate-y-1 hover:shadow-sport-500/30" 
          ...
          <!-- Stats rápidos -->
          <div class="mt-16 flex flex-wrap gap-10 overflow-hidden">
            <div class="animate-slide-up-fade delay-1200">
      ...
      <!-- Mitad Imagen -->
      <div class="flex-1 w-full lg:w-1/2 h-[60vh] lg:h-[85vh] relative overflow-hidden">
        <div class="absolute inset-0 bg-gradient-to-r from-zinc-950 to-transparent z-10 lg:block animate-fade-in-delay delay-900"></div>
        <img src="https://brand.assets.adidas.com/image/upload/f_auto,q_auto:best,fl_lossy/if_w_gt_800,w_800/7361768_CAM_LAM_FTD_SS_26_MAY_29_FOOTBALL_WC_KICK_OFF_ONSITE_TEASER_CAROUSEL_1050x1400_CO_5d65cbafe6.png"
             alt="Deportista en acción" class="w-full h-full object-cover object-center animate-scale-image" />
      </div>
    </section>
    ...
    <section class="mx-auto max-w-7xl px-6 py-24">
      ...
      <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        ...
        <a href="/productos?categoria=Camisetas" data-link class="group relative h-64 rounded-2xl overflow-hidden flex flex-col justify-end p-5 border border-zinc-200 dark:border-zinc-800 hover:border-sport-500 shadow-sm transition-all hover:-translate-y-1">
          ...
          <p class="relative z-20 text-xs text-zinc-300 mt-0.5 flex items-center gap-1">Ver productos <svg class="w-3 h-3" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"></path></svg></p>
        </a>
    ...
    <section class="bg-zinc-100 dark:bg-zinc-900 py-24 transition-colors">
      <div class="mx-auto max-w-7xl px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
        <div class="p-8 rounded-3xl bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 hover:border-sport-500/50 transition-colors group">
          <div class="w-12 h-12 rounded-2xl bg-sport-100 dark:bg-sport-950/40 flex items-center justify-center text-sport-500 mb-6">
